        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-4">
              <div className="flex gap-4">
                <a href="https://www.instagram.com/zentheragroups?igsh=OWhvdXd6anJzMXhs" target="__blank" className="w-10 h-10 border border-white/10 flex items-center justify-center hover:bg-zenthera-gold hover:border-zenthera-gold hover:text-black transition-all duration-300">
                  <Instagram size={18} />
                </a>
                <a href="https://www.linkedin.zentheragroups.com" target="__blank" className="w-10 h-10 border border-white/10 flex items-center justify-center hover:bg-zenthera-gold hover:border-zenthera-gold hover:text-black transition-all duration-300">
                  <Linkedin size={18} />
                </a>
              </div>
            </div>
